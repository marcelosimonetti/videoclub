<div class="peliculas index">
	...
	<tr>
		...
		<td><?php echo h($pelicula['Pelicula']['anio']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $pelicula['Pelicula']['id']), null, __('Are you sure you want to delete # %s?', $pelicula['Pelicula']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
